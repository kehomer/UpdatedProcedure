const proc = {
  ...
  
  {
    ...
    {
      'number': '3.7.1.',
      'text': 'The Carburetor is attached to the Generator through a wire and should be rested upside down as shown in the figure.',
...

  {
    ...
    {
      'number': '6.4.',
      'text': 'Reattach the Right Hand Vent Tube to the Carburetor by pushing the tube upwards into its connection tab.',
